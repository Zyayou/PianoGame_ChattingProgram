...
CsocServerDlg::CsocServerDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_SOCSERVER_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CsocServerDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_LBN_SELCHANGE(IDC_LIST2, &CsocServerDlg::OnLbnSelchangeList2)
	ON_LBN_SELCHANGE(IDC_LIST1, &CsocServerDlg::OnLbnSelchangeList1)
	...
	ON_BN_CLICKED(IDOK, &CsocServerDlg::OnBnClickedOk)
END_MESSAGE_MAP()
...
afx_msg LRESULT CsocServerDlg::OnAcceptSocket(WPARAM wParam, LPARAM lParam)
{
	...
	while (pos != NULL)
	{
		...
		if (pClient != NULL)
		{
			...
			str.Format(_T("신규 접속자가 있습니다."), (int)(m_pClientSocket));
...
void CsocServerDlg::OnLbnSelchangeList2()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
}


void CsocServerDlg::OnLbnSelchangeList1()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
}


void CsocServerDlg::OnBnClickedOk()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	CDialogEx::OnOK();
}
